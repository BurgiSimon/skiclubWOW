...
bun add @gsap/react gsap

# usage

import ThreeDTextReveal from "./3d-text-reveal";

<ThreeDTextReveal
items={["Explore", "The", "Future", "Of", "Design"]}
